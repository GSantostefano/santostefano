  ...
  return (
    <footer className="flex flex-col items-center w-full py-5 px-8 text-sm text-white bg-stone-950">
      ...
      <div className="flex space-x-4 mb-4">
        <a href="https://github.com/GSantostefano" target="_blank" rel="noopener noreferrer" className="text-white">
          <FontAwesomeIcon icon={faGithub} size="2x" />
        </a>
        <a href="https://www.linkedin.com/in/gabriel-santostefano/" target="_blank" rel="noopener noreferrer" className="text-white">
