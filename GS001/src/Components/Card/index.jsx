...
const Componente = () => {
  ...
  return (
    ...
    <div
    className='bg-black/30 ml-5 cursor-pointer w-56 h-60 rounded-lg hover:bg-white/10 hover:shadow-white hover:shadow-lg'
      >
      <figure className='relative mb-2 w-full h-4/5'>
        <span className='absolute bottom-0 left-0 bg-black/40 rounded-lg text-white text-xs m-2 px-3 py-0.5'>Producto</span>
