      ...
      <img src={perfilImage} alt="Perfil" className="rounded-full w-5/12 h-auto mx-auto mb-4" />
        ...
        <section>
          ...
          <div className="mt-5 flex space-x-4 mb-4">
            <a href="https://github.com/GSantostefano" target="_blank" rel="noopener noreferrer" className="text-white hover:text-lime-500 ">
              <FontAwesomeIcon icon={faGithub} size="2x" />
            </a>
            <a href="https://www.linkedin.com/in/gabriel-santostefano/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-lime-500 ">
              <FontAwesomeIcon icon={faLinkedin} size="2x" />
            </a>
            <a href="https://www.instagram.com/gacho.santoss/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-lime-500 ">
              <FontAwesomeIcon icon={faInstagram} size="2x" />
            </a>
            <a href="https://wa.me/5493435066052" target="_blank" rel="noopener noreferrer" className="hover:text-lime-500  text-white">
